...
export function WorkspaceInviteLanding() {
  ...
  if (rejected) {
    return (
      <main className="mx-auto max-w-md px-4 py-16 text-center">
        <p data-testid="invite-rejected" className="font-serif text-lg text-ink">
          Invitation declined.
        </p>
  ...
  if (wrongAccount) {
    return (
      <main className="mx-auto max-w-md px-4 py-16 text-center">
        <p data-testid="invite-wrong-account" className="font-serif text-lg text-ink">
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-16 text-center">
      <h1 className="font-serif text-xl text-ink">You've been invited to a workspace</h1>
      <p className="mt-1 text-sm text-muted">Accept to join, or decline the invitation.</p>
      ...
      <div className="mt-6 flex justify-center gap-3">
        <button
          ...
          className="min-h-[40px] rounded-md bg-accent px-5 text-sm font-medium text-on-accent disabled:opacity-60"
        >
          {busy ? "Joining…" : "Accept"}
        </button>
        <button
          ...
          className="min-h-[40px] rounded-md border border-line bg-surface px-5 text-sm text-ink hover:border-accent disabled:opacity-60"
        >
          Decline
        </button>
      </div>
