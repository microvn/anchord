...
const ICONS: Record<string, string> = {
  ...
  // lucide Star — the Like annotation glyph (replaces the 👍 emoji on the looks-good preset), kept in
  // lockstep with the toolbar/popover Like icon (lucide Star) so the type reads identically everywhere.
  star: '<path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"/>',
  // lucide Eraser — the redline/Delete glyph, matching the toolbar/popover Redline icon (lucide Eraser).
  eraser:
  ...
  // lucide Monitor — the "System" appearance option (follow the OS), paired with sun/moon on the
  // viewer overflow menu's Appearance control.
  monitor:
    '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>',
  // lucide Printer — the "Print / Save as PDF" action.
  printer:
  ...
  // lucide Download — tray + down arrow; the "Download annotations" action.
  download:
  ...
  // Keyboard-hint glyphs for the Shift+Enter send affordance on the comment composer + reply box.
  // shift = the ⇧ keycap outline (hollow up-arrow); cornerDownLeft = the ↵ return/enter arrow.
  shift: '<path d="M12 3.5 19 11h-4v6.5H9V11H5z"/>',
