...
**Date:** 2026-06-14
**Ref:** --
**Reason:** pre-2026-06-14-edit state. NOTE: reconstructed from git HEAD (4f07bd1) after the original
same-day snapshot was accidentally overwritten; this is the last committed spec state, which equals
the pre-edit state since the 2026-06-14 update was the first change after HEAD.
