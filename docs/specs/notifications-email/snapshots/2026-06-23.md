...
**Date:** 2026-06-23
**Ref:** --
**Reason:** M6 — C-006 channel-policy invariant changes meaning (doc-share `invited` reclassified from low-signal/in-app-only to email-eligible by default), per notification-preferences C-003/AS-006.
