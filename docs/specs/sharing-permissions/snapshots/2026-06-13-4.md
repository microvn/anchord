...
**Date:** 2026-06-13
**Ref:** --
**Reason:** M5 — S-006 AS-025 Then + ## API GET …/share now return `viewerRole` (caller's own role); + Linked Field. Lets the FE owner-only gate (C-003) work from any dialog entry point.
