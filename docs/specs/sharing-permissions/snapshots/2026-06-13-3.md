...
**Date:** 2026-06-13
**Ref:** --
**Reason:** M5 — S-003 AS-007/AS-008 Then now return the new member id; ## API POST /invites → 201 { status, id }; + Linked Field (invite id consumed by sharing-permissions-ui S-006)
