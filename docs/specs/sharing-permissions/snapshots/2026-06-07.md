...
**Date:** 2026-06-07
**Ref:** --
**Reason:** M6 — document build-time S3 guards as constraints + AS: C-012 (link/invite role validation), C-013 (link-check ordering), C-014 (rate-limit reset), expiry-boundary refinement of C-005
...
- C-005: Expired link or over view-limit → stops working ("not available" page). (AS-010, AS-011)
