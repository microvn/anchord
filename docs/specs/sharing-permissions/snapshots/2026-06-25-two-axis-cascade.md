...
**Reason:** M6 — constraints/data-model superseded by the two-axis access model (Data Model + C-009/C-018 + S-001/S-006 describe the single general_access level + share_links.role)
