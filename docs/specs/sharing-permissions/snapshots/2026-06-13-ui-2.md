...
**Date:** 2026-06-13
**Ref:** --
**Reason:** M5 — C-003 + AS-009: the owner-only editors_can_share gate now sources owner-ness from the read's `viewerRole` (works from the docs-list ⋯ entry too), not the passed `effectiveRole`; + Linked Field.
