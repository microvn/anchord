...
**Date:** 2026-06-15
**Ref:** S1 (workspace-context) + S3 (default-viewer) from /mf-build
**Reason:** M5 — add AS-030 (member workspace context on doc-scoped viewer); expand S-002 producer (read response carries doc workspaceId)
