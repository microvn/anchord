...
**Date:** 2026-06-19
**Ref:** --
**Reason:** M5 — AS-001 switcher label rule changed (drop admin-qualified "My <name>"/"<admin>'s <name>"; show title-cased name; only the owner's default workspace reads "My Default").
