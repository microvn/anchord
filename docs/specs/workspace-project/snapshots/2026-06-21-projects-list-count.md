...
**Date:** 2026-06-21
**Ref:** --
**Reason:** M-new-AS — S-003 gains AS-028: the projects-list read carries each project's accessible-doc count, retiring the useProjectsBrowse per-project count fan-out.
...
- C-003: Browse and search always filter down to docs the user has access to (no out-of-access
  ...
  results (avoid existence leak). [harden H2] (AS-006, AS-009, AS-026)
