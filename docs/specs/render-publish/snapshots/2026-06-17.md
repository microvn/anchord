...
**Date:** 2026-06-17
**Ref:** --
**Reason:** M1 (new story S-007 — in-iframe client-storage shim), M6 (new constraint C-010)
...
Stories=6 (under target 7). AS=23 (target 20, in the G7 overage range ≤30). The overage comes from the
2026-06-11 additions for the React viewer (direction B) plus the 2026-06-13 effectiveRole atom, each AS one atom:
