...
**Date:** 2026-06-26
**Ref:** be-create-vis
**Reason:** M6 — C-001 extended so web user-created visibility is overridable at create (not just MCP); the create-time control AS lives in the FE spec (BE at the 30-AS hard cap).
