...
**Date:** 2026-06-19
**Ref:** annotation-reanchor (sub-spec extraction)
**Reason:** M6 — C-001/C-002 re-anchor semantics superseded/delegated to the new `annotation-reanchor` sub-spec (S1 model); GAP-001 resolved.
