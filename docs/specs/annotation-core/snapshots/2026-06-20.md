...
**Date:** 2026-06-20
**Ref:** --
**Reason:** M4 — guest commenting no longer gated by a toggle (sharing-permissions reversal): anon-write gated by link role ≥ commenter. AS-016/AS-017 Given updated to drop "guest commenting enabled".
