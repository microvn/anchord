...
**Date:** 2026-06-14
**Ref:** --
**Reason:** M4+M6 (kind-conditional layout — C-006; S-001/002/003 per-kind; S-002 scoped to Markdown + AS-018)
**Note:** restored from git HEAD (4f07bd1) on 2026-06-14 after an accidental overwrite during an annotation-core Mode C run; content is the 2026-06-11 committed state (the pre-kind-conditional state this snapshot captured).
